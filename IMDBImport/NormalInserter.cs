...
namespace IMDBImport
{
	public class NormalInserter : IInserter
	{
		...
		public void InsertNames(List<Name_Model> names, SqlConnection sqlConn) { throw new NotImplementedException(); }
		public void InsertNameTitles(List<NameTitle_Model> nameTitles, SqlConnection sqlConn) { throw new NotImplementedException(); }
		public void InsertNameProfessions(List<NameProfession_Model> nameProfessions, SqlConnection sqlConn) { throw new NotImplementedException(); }
